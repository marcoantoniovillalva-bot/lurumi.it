...
// ── Credenziali ────────────────────────────────────────────
const REPLICATE_TOKEN   = process.env.REPLICATE_API_TOKEN   || 'r8_0TIO5579Oj0XGWslaj7J7c037ZhXKbG0t6Kzi'
const SUPABASE_URL      = process.env.NEXT_PUBLIC_SUPABASE_URL      || 'https://djatdyhqliotgnsljdja.supabase.co'
const SUPABASE_SERVICE  = process.env.SUPABASE_SERVICE_ROLE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRqYXRkeWhxbGlvdGduc2xqZGphIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3MTkzNjY2NiwiZXhwIjoyMDg3NTEyNjY2fQ.Ikj5LIbngEab8rF907J24SnaELKM65L67U9veixV-x8'
